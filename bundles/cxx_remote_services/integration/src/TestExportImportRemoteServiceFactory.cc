...
private:
    ...
    std::shared_ptr<celix::SynchronousPushEventSource<double>> ses {psp.createSynchronousEventSource<double>()};
    std::shared_ptr<celix::PushStream<double>> stream {psp.createStream<double>(ses)};
public:
